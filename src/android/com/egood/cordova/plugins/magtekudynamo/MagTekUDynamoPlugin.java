...
//	public static final String TOAST = "toast";
	...
	void setAudioConfigManual() throws MTSCRAException {
		...
		Log.d("MagReader","Device Model: " + model);
		...
		try {
			if(model.contains("DROID RAZR") || model.toUpperCase().contains("XT910")) {
				...
				mMTSCRA.setConfigurationParams("INPUT_SAMPLE_RATE_IN_HZ=32000,");
	        		 ...
	        		 model.equals("SGH-I747")||// S3 AT&T
	        		 model.equals("M532")||//Fujitsu
	        		 model.equals("GT-N7100")||//Notes 2 
	        		 model.equals("GT-N7105")||//Notes 2 
	        		 model.equals("SGH-I317")||// Notes 2
	        		 model.equals("SCH-I605")||// Notes 2
	        		 model.equals("SCH-R950")||// Notes 2
	        		 model.equals("SGH-T889")||// Notes 2
	        		 model.equals("SPH-L900")||// Notes 2
	        		 model.equals("SGH-I337")||// S4
	        		 model.equals("SGH-M919")||// S4
	        		 model.equals("SCH-I545")||// S4
	        		 model.equals("SPH-L720")||// S4
	        		 model.equals("SCH-R970")||// S4
	        		 model.equals("SCH-R970X")||// S4
	        		 model.equals("SCH-R970C")||// S4
	        		 model.equals("SM-G900A")||// S5
	        		 model.equals("SM-G900H")||// S5
	        		 model.equals("SM-J500H")||// J5
	        		 model.equals("SM-J700H")||// J7
	        		 model.equals("GT-P3113"))//Galaxy Tab 2, 7.0
    		{
				Log.d("MagReader", "Setting configuration to model: " + model);
				...
				Log.d("MagReader", "Using default settings!");
				mMTSCRA.setConfigurationParams("INPUT_AUDIO_SOURCE=VRECOG,");
			}
		} catch(MTSCRAException ex) {
			Log.d("MagReader", "Exception: " + ex.getMessage());
...
*/		
			...
			Log.d("MagReader","Listen For Events called!");
...
//		response.put("Swipe.Count", mMTSCRA.getSwipeCount());
		...
		Log.d("MagReader","Response: " + response);
