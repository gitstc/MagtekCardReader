...
MagTek.isDeviceConnected = function(callback, error) {
    ...
    cordova.exec(success, function(error){
		console.log("isDeviceConnected Error: " + JSON.stringify(error));
		fail_handler ? fail_handler(error) : false;
	}, 'com.egood.magtek-udynamo', 'isDeviceConnected', []);
};
...
MagTek.isDeviceOpened = function(callback, error) {
    ...
    cordova.exec(success, function(error){
		console.log("isDeviceOpened Error: " + JSON.stringify(error));
		fail_handler ? fail_handler(error) : false;
...
MagTek.openDevice = function(callback, error) {
    ...
    cordova.exec(success, function(error){
		console.log("openDevice Error: " + JSON.stringify(error));
		fail_handler ? fail_handler(error) : false;
...
MagTek.listenForEvents = function(callback, events, error) {
    ...
    cordova.exec(success, function(error){
		console.log("listenForEvents Error: " + JSON.stringify(error));
		fail_handler ? fail_handler(error) : false;
	}, 'com.egood.magtek-udynamo', 'listenForEvents', events);
};
